...
```
## THIBIGA
Har gjort en endring her, endret fra "Naering" til "Knr". Hvis vi bruker Knr får vi kommunenummerene som variabel. "Vi trenger antall sysselsatte innenfor ulike bransjer per kommune ... .". Nå kan vi endre navnene på knr'ene.
...
```
## THIBIGA
Forskjellen er at nå bruker "Sysselsatte" mens i den forrige brukte vi "SysselsatteArb".
...
```
## THIBIGA
Denne chunken vil ikke kjøre, skal vi bare fjerne den? Det er igen variabel som heter (-NAstatus), så vi kan bare fjerne denne.
