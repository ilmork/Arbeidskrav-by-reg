...
Tab_03321_andeler %>%
  ...
  filter(
    b_knavn_new %in% c("Tysvær", "Karmøy", "Sauda", "Haugesund", "Bokn", "Utsira", "Vindafjord", "Etne", "Sveio", "Bømlo", "Stord", "Fitjar", "Tysnes", "Kvinnherad", "Ullensvang")
>>>>>>> 53b17ab303bc3ab63600c06a7d1c7c0d087bccbf
    ) %>%
...
Tab_03321_a_og_b %>%
  select(aar, b_knavn_new, Andel_B_og_A) %>%
  filter(
    b_knavn_new %in% c("Tysvær", "Karmøy", "Sauda", "Bokn", "Utsira", "Vindafjord", "Etne", "Sveio", "Bømlo", "Stord", "Fitjar", "Tysnes", "Kvinnherad", "Ullensvang")
    ) %>%
  ggplot(mapping = aes(x = aar, y = Andel_B_og_A, colour = b_knavn_new)) +
  geom_line(aes(group = b_knavn_new), lwd = 1) +
  theme(legend.position = 'bottom')
```
=======
