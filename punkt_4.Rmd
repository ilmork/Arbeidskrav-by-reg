...
Tab_03321_a_og_b %>%
  ...
  select(aar, b_knavn_new, Andel_B_og_A) %>%
  filter(
    b_knavn_new %in% c("Tysvær", "Karmøy", "Sauda", "Bokn", "Utsira", "Vindafjord", "Etne", "Sveio", "Bømlo", "Stord", "Fitjar", "Tysnes", "Kvinnherad", "Ullensvang", "Haugesund")
=======
#beregne og presentere andeler av arbeidstakerne med bosted i en kommune som har arbeidssted i andre kommuner, og gjør det samme for andelen av jobbene i en kommune som er besatt av arbeidstakere fra andre kommuner. Diskuter forskjeller mellom kommunene i regionen, og drøft utviklingen over tid for ulike kommuner
```
...
# i) 
Ut i fra disse grafene vi viser frem kan vi se at det er to kommuner som skiller seg ut når det kommer til pendling ut av kommunen. Vi ser at Sveio og Tysvær ligger høyest pendling fra sine kommuner. En grunn til dette er at kommunene ligger gunstig til med reiseavstand ut til flere andre kommuner. Ser vi på Bokn så kan vi se at de har hatt den største prosentøkningen og de største svingningen fra 2000-2020. Vi kan se at Bokn fikk en brå økning i pendlere ut av kommunen rundt 2011. Dette kan være effekten av at T-forbinelsen var i gang og de som bor på Bokn så for seg kortere avstander for å reise til jobb, men vi ser at når T-forbindelsen åpnet i 2013, så avtar grafen igjen og går mot tallene som var i 2011. 
...
# Leker meg bare med ggplot og tester ut ting
