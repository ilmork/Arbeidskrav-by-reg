...
Tab_03321_00 <- ApiData(
  urlToData = "03321",
  # paste0 virker, men as.character er kanskje litt mer rett frem
  ArbstedKomm = as.character(
    c(
    1106, 1135, 1145, 1146, 1149, 1151, 1154, 1159, 
    1211, 1216, 1219, 1221, 1222, 1223, 1224, 1228, 1231)
    ), 
